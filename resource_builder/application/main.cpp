...
int main(int argc, char** argv) try
{
	...
	std::unique_ptr<resource_builder::BaseCompilerParameters> parameters = createParameters(compilerName);
	...
	resultFile << getterSignature << R"( const std::vector<uint8_t>& getResource(const std::string& resourceName)
{
	...
	command.insert(0, "call \"C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Auxiliary\\Build\\vcvars64.bat\" && ");
#endif
